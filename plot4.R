...
#Setting the screen device to fit 4 plots
par(mfrow = c(2, 2))
...
#Plot 1
with(electricData, plot(Global_active_power ~ datetime, xlab = "", ylab = "Global Active Power", type = "l"))

#Plot 2
with(electricData, plot(Voltage ~ datetime, xlab = "datetime", ylab = "Voltage", type = "l"))
...
with(electricData, { 
        ...
        legend("topright",lty = 1, col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), bty = "n", y.intersp = 0.2)
})

#Plot 4
with(electricData, plot(Global_reactive_power ~ datetime, xlab = "datetime", ylab = "Global_reactive_power", type = "l"))
