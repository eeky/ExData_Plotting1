...
#Plot 3
with(electricData, plot(Sub_metering_1 ~ datetime, xlab = "", ylab = "Energy sub metering", type = "l"))
legend("topright", lty = 1, col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), cex = 0.8, y.intersp = 0.5)
points(electricData$Sub_metering_2 ~ datetime, col = "red", type = "l" )
points(electricData$Sub_metering_3 ~ datetime, col = "blue", type = "l")
